...
.controller('MainController', function($scope, State, $window) {
  $scope.data = { firstname: 'kyle', lastname: 'kyle', age: 23, gener: 'M', url: 'https://journalism.missouri.edu/wp-content/uploads/2011/10/greeley-kyle-200x300.jpg', aboutme: 'I like food'};
